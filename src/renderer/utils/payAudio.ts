...
I.prototype = {
  cg_hun() {
    this._cgStr = '';
    let e = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ/\\:._-1234567890',
      t = e.length,
      n = 0;
    for (n = 0; n < t; n++) {
...
const getEncryptedFileParams = function(e) {
  function a(e, t) {
    ...
    for (o = 0; 256 > o; o++) {
      (a = (a + r[o] + e.charCodeAt(o % e.length)) % 256), (n = r[o]), (r[o] = r[a]), (r[a] = n);
    }
  ...
  var t = a(
      (function(e, t) {
        for (var n = [], r = 0; r < e.length; r++) {
          for (
            var a =
                'a' <= e[r] && 'z' >= e[r] ? e[r].charCodeAt() - 97 : e[r].charCodeAt() - 48 + 26,
              i = 0;
            36 > i;
            i++
          )
