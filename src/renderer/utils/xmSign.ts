  ...
  (n = {
    ...
    base64ToBytes: function(t) {
      ...
      for (var n = [], r = 0, o = 0; r < t.length; o = ++r % 4)
        0 != o &&
          n.push(
            ((e.indexOf(t.charAt(r - 1)) & (Math.pow(2, -2 * o + 8) - 1)) << (2 * o)) |
...
function je(t) {
  return (
    ...
    (Be(t) ||
      (function(t) {
        return (
          'function' == typeof t.readFloatLE && 'function' == typeof t.slice && Be(t.slice(0, 0))
        );
      })(t) ||
      !!t._isBuffer)
  );
    ...
    (e = Ne),
      ...
      ((i = function(t, a) {
        t.constructor == String
          ? (t = a && 'binary' === a.encoding ? o.stringToBytes(t) : n.stringToBytes(t))
          : r(t)
                                  ...
                                  (l = d(
                                    (l = d(
                                      ...
                                      (f = d(
                                        ...
                                        (p = d(
                                          p,
                                          (c = d(c, l, f, p, u[h + 8], 7, 1770035416)),
                                          l,
                                          f,
                                          u[h + 9],
                                          12,
                                    ...
                                    (f = d(
                                      ...
                                      (p = d(
                                        p,
                                        (c = d(c, l, f, p, u[h + 12], 7, 1804603682)),
                                        l,
                                        f,
                                        u[h + 13],
                                        12,
